...
df = pd.read_csv(r'C:\Users\user\Desktop\Dibatese_detection-using-ML-main\Dibatese_detection-using-ML-main\diabetes.csv')
...
# Age vs Pregnancies
# Assuming you changed 'age' to 'Age' and 'pregnancies' to 'Pregnancies' in user_data
